...
export default function Footer() {
  return (
    <footer className="w-full light:bg-white mt-16 dark:bg-black light:text-black dark:text-white py-6 px-4 border-t light:border-gray-200 dark:border-white/10">
