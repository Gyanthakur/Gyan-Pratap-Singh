...
export default function Contact({ theme }) {
	...
	return (
		<section
			className={`relative w-full min-h-screen px-4 py-12 sm:px-6 lg:px-8 transition-colors duration-300 ${
				isDark ? 'bg-black text-white' : 'bg-white text-black'
			}`}
		>
			<div
				className={`max-w-4xl mx-auto border rounded-2xl p-6 sm:p-10 shadow-xl backdrop-blur-md space-y-8 transition-all duration-300 ${
					isDark
			...
			>
				...
				>
					...
					<div>
						...
						<input
							...
							required
							placeholder="Your name"
							className={`w-full rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition ${
								isDark
				...
				{/* Social Section */}
				<div className={`pt-8 border-t ${isDark ? 'border-gray-600' : 'border-gray-200'}`}>
